...
- `README.md`, `PRD.md`, `docs/ARCHITECTURE_v2.md` don't document the task engine or skills at all. `PRD_v3.md` and the v3 design/plan docs in `docs/superpowers/` do.
...
You are being handed this brief to produce the **v4 PRD, design docs, and phased implementation plans** in the same style as `docs/superpowers/specs/PRD_v3.md` and `docs/superpowers/plans/2026-04-04-agentcos-v3.md` (TDD, checkbox tasks, commit per task).

Before writing anything:
1. Read `CLAUDE.md`, `docs/FABLE_ENTRY_POINT.md`, `docs/superpowers/specs/PRD_v3.md`, `docs/superpowers/specs/2026-04-06-orchestrator-agent-design.md`.
